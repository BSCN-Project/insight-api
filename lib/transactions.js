...
TxController.prototype.transformTransaction = function(transaction, options, callback) {
  ...
  if(transaction.height >= 0) {
    confirmations = this.node.services.bscnd.height - transaction.height + 1;
  }
  ...
  var transformed = {
    ...
    isbrc20Transfer: transaction.isbrc20Transfer,
  };
...
TxController.prototype.transformBscnTransaction = function(transaction) {
